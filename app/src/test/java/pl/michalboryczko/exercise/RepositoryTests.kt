...
import pl.michalboryczko.exercise.source.repository.CryptocurrencyRepositoryImpl
...
class RepositoryTests: BaseTest() {
    ...
    private val checker = Mockito.mock(InternetConnectivityChecker::class.java)
    private val repo by lazy { CryptocurrencyRepositoryImpl(restApi, webSocketService, CryptocurrencyMapper(), checker) }
